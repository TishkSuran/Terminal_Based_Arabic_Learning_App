...
public class Arabic_Listening_Test_Intermediate extends Arabic_Listening_Test_Base {
    public Arabic_Listening_Test_Intermediate() {
        super(new String[]{"Favourite.wav", "Good_morning.wav", "I_love_you.wav", "Interesting.wav", "No_problem.wav", "Of_course.wav", "Thank_you_very_much.wav", "Thats_good.wav", "What_is_that.wav", "You_are_welcome.wav"}, "src/Arabic_Words_Intermediate", "src/Audio_Method_And_Transcription_Files/transcriptions_intermediate.txt");
    }
